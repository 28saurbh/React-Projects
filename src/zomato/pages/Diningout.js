...
import Dining_items from '../components/Dining/Dining_items';
function Diningout() {
    return (
        <>
            ...
            <div className='background-gray'>
                <div className='container'>
                    ...
                    <div className='collection-text'>
                        <span>Explore curated lsts of top restaurants, cafes, pubs, and bars in Jabalpur, based on trends</span>
                        <span>All collections in Jabalpur</span>
                    </div>
                    ...
                    <div className="collection-items">
                        ...
                        <div className="item ">
                            ...
                            <p className="img-title">Terrofic Thali</p>
